...
var ANRDF=0;
var ANVDT=0;
var ANSCC="unescape(getTitle()).toLowerCase()";
var ANSAVN='unescape(ANVSA).toLowerCase()';
var ANTID;
var ANTPUD;
var ANTPTG;
var ANURL=0;
var AN2CCDA=new Array("oil gold and copper","income statement","markets&economy","key measures","SEC Filings","currencies","investment","investing","cash flow","consensus","earnings","holdings","industry","holdings","economy","profile","balance","charts","trends","stock","bond","funds","cnbc");
var AN2CCOP=new Array("c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c","c");
var AN2CCCC=new Array("INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","INV","ABG","BZN");
var ANCB1=0;
var ANCB3=0;
var ANCCT;
var ANRD='';
...
function getTitle()
{
var title=unescape(document.getElementsByTagName('title')[0].text);
title=title.replace(/(<([^>]+)>)/ig,"").replace(/[_\s+-\/:]/g,"");
return title;
}
